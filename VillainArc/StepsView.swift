...
struct StepsView: View {
    ...
    @State private var selectedStepRange: stepGraphRange = .week
        ...
        ZStack {
            ...
            VStack {
                Picker("Time Range", selection: $selectedStepRange) {
                    Text("Week").tag(stepGraphRange.week)
                    Text("Month").tag(stepGraphRange.month)
                    Text("6 Months").tag(stepGraphRange.sixMonths)
                }
